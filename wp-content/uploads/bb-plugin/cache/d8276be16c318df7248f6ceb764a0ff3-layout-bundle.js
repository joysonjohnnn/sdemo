...
$('.uabb-row-separator').parents('html').css('overflow-x','hidden');});YUI({'logExclude':{'yui':true}}).use('fl-slideshow',function(Y){if(null===Y.one('.fl-node-60b656ea7f9d3 .fl-bg-slideshow')){return;}
var oldSlideshow=Y.one('.fl-node-60b656ea7f9d3 .fl-bg-slideshow .fl-slideshow'),newSlideshow=new Y.FL.Slideshow({autoPlay:true,bgslideshow:true,crop:true,loadingImageEnabled:false,randomize:false,responsiveThreshold:0,touchSupport:false,source:[{type:"urls",urls:[{thumbURL:"/wp-content/uploads/2021/06/Slider-1-150x150.jpg",largeURL:"/wp-content/uploads/2021/06/Slider-1-1024x515.jpg",x3largeURL:"/wp-content/uploads/2021/06/Slider-1.jpg",caption:"",alt:"",},{thumbURL:"/wp-content/uploads/2021/06/Slider-2-150x150.jpg",largeURL:"/wp-content/uploads/2021/06/Slider-2-1024x515.jpg",x3largeURL:"/wp-content/uploads/2021/06/Slider-2.jpg",caption:"",alt:"",},{thumbURL:"/wp-content/uploads/2021/06/Slider-3-150x150.jpg",largeURL:"/wp-content/uploads/2021/06/Slider-3-1024x515.jpg",x3largeURL:"/wp-content/uploads/2021/06/Slider-3.jpg",caption:"",alt:"",},{thumbURL:"/wp-content/uploads/2021/06/Slider-4-Flipped-150x150.jpg",largeURL:"/wp-content/uploads/2021/06/Slider-4-Flipped-1024x515.jpg",x3largeURL:"/wp-content/uploads/2021/06/Slider-4-Flipped.jpg",caption:"",alt:"",}]}],speed:6000,stretchy:true,stretchyType:'contain',transition:'fade',transitionDuration:1.5});if(oldSlideshow){oldSlideshow.remove(true);}
jQuery('.fl-node-60b656ea7f9d3').imagesLoaded(function(){newSlideshow.render('.fl-node-60b656ea7f9d3 .fl-bg-slideshow');});});!function(name,definition){if(typeof module!='undefined'&&module.exports)module.exports=definition()
else if(typeof define=='function'&&define.amd)define(name,definition)
else this[name]=definition()}('bowser',function(){var t=true
function detect(ua){function getFirstMatch(regex){var match=ua.match(regex);return(match&&match.length>1&&match[1])||'';}
function getSecondMatch(regex){var match=ua.match(regex);return(match&&match.length>1&&match[2])||'';}
